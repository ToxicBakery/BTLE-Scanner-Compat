...
public class ScanRecordCompat {
                ...
                switch (fieldType) {
                    ...
                    case DATA_TYPE_SERVICE_UUIDS_16_BIT_COMPLETE:
                        parseServiceUuid(
                                ...
                                currentPos,
                                dataLength,
                                BluetoothUuidCompat.UUID_BYTES_16_BIT,
                                serviceUuids);
                        break;
                    ...
                    case DATA_TYPE_SERVICE_UUIDS_32_BIT_COMPLETE:
                        parseServiceUuid(
                                ...
                                currentPos,
                                dataLength,
                                BluetoothUuidCompat.UUID_BYTES_32_BIT,
                                serviceUuids);
                        break;
    ...
    public String toString() {
        return "ScanRecord [mAdvertiseFlags=" + mAdvertiseFlags + ", mServiceUuids=" + mServiceUuids
                + ", mManufacturerSpecificData=" + BluetoothUtilsCompat.toString(mManufacturerSpecificData)
                + ", mServiceData=" + BluetoothUtilsCompat.toString(mServiceData)
